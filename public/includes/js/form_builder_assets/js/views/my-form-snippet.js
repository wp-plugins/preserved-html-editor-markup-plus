define([
  ...
  return SnippetView.extend({
    ...
    , mouseDownHandler : function(mouseDownEvent){
      ...
      //Activate tooltips
      //console.log('in-app-trigger-2-2');
      $(".popover").trigger(toolTipEvent);
    ...
    , saveHandler : function(boundContext) {
      return function(mouseEvent) {
        ...
        //check to see if name is filled out
        if (!$('.popover-content #id').hasClass('error_input') && !$('.popover-content #name').hasClass('error_input')) {
